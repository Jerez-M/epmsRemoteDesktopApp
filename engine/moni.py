...
connectiondb = pymysql.connect(host="localhost", user="Jeremiah", password="0202February.", database="employees", port=3306)
# connectiondb = MySQLdb.connect(host="localhost", user="Jeremiah", password="0202February.", database="employees", port=3306)

# connectiondb = mysql.connector.connect(host="localhost", user="Jeremiah", password="0202February.", database="employees", port=3306)
